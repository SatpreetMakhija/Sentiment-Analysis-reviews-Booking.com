...
link_to_data = current_path + "/dataset/bangkok.json"
...
for j in range(len(data_content)):
    ...
    new_hotel_details.append( [data_content[j]["name"], float(data_content[j]["score"]), statistics.median(temp_list)*10, data_content[j]["location"]] )
